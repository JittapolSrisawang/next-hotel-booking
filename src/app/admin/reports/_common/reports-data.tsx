...
async function ReportsData({ searchParams }: { searchParams: any }) {
  ...
  return (
    <div>
      <div className="md:flex-row flex-col flex gap-10 text-center">
        <div
        ...
        >
          <h1 className="text-xl font-bold text-gray-600">ยอดจองทั้งหมด</h1>
          <h1
        ...
        >
          <h1 className="text-xl font-bold text-gray-600">รายได้รวม</h1>
          <h1
